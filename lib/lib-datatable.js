...
const LIB_DATATABLE_ADDRESSING = require( './datatable-addressing.js' );
...
function NewDatatable()
{
	...
	let datatable =
	{
		...
		RowCol: LIB_DATATABLE_ADDRESSING.RowCol,
		SetSize: LIB_DATATABLE_ADDRESSING.SetSize,
		RowCount: LIB_DATATABLE_ADDRESSING.RowCount,
		ColumnCount: LIB_DATATABLE_ADDRESSING.ColumnCount,
